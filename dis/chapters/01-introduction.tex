...
these executive functioning barriers. This research seeks to transition the IDE from a passive tool into an active cognitive partner through AI-driven support.


\subsection{Problem Statement}
While modern IDEs are feature-rich, their design reflects a \gls{neurotypical-bias} that assumes a high baseline for filtering sensory input and managing 
...
frequently experience task paralysis during project initiation~\cite{bramham2009executive}, while those with \gls{ASD} may struggle with the \gls{double_empathy} problem, leading to them misinterpreting 
