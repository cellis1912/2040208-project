...
Target: Develop a single \textit{Minimalist Toggle} feature that simultaneously hides non-essential \gls{UI} elements, including the Activity Bar, Status Bar, Mini-map, and Breadcrumbs.
...
Justification: This minimizes the cognitive demand of interpreting dense text, preventing rabbit holes and supporting the literal communication needs identified in the \Gls{double_empathy}
...
Target: To create at least two visual presets, such as \textit{Soft High Contrast}, that adhere to \gls{WCAG} 2.1, set of international standards designed to make web content more accessible to people with disabilities it can also help with visual processing, eye strain and enhance readability~\cite{bengtsson2025web}.
...
\begin{itemize}
  ...
  software engineering as well as the shift toward a more \gls{social_model} of disability rather than a \gls{medical_model}.
  \item \textbf{Section 3: Design and Implementation} Details the user requirements and the three-layer system architecture. This chapter explains the technical
   execution of \textit{Minimalist Toggle} and \textit{Task Architect} as well as the visual presets and styling tools. I will also discuss issues encountered during development and how they were resolved, such as the design of the UI and issues with the AI integration and prompt generation.
