...
successfully. For a developer, \gls{executive_dysfunction} is not a lack of technical ability, but rather a barrier in three key areas: Inhibitory Control
 (filtering IDE distractions), Working Memory (tracking complex syntax), and Cognitive Flexibility (switching between high-level logic and low-level code).
...
Target: To create at least two visual presets, such as ``Soft High Contrast'', that adhere to \gls{WCAG} 2.1 guidelines to reduce eye strain and enhance readability~\cite{bengtsson2025web}.
