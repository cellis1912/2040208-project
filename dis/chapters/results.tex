...
The results indicate a substantial and statistically significant reduction in perceived workload when using the Dashboard interface compared to the Vanilla interface.
