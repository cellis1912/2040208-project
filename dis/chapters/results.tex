...
As shown in Table 6, participants reported consistently lower weighted NASA-TLX scores when using the dashboard interface compared to the vanilla IDE.
...
For developers with \gls{ASD} or \gls{ADHD}, inconsistency is a major source of ``cognitive friction''. If a button moves or a shortcut changes, it can break their focus
...
Maintaining response latency below two seconds is particularly important for neurodivergent users, as prolonged waiting periods can disrupt 
