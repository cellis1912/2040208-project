...
\begin{itemize}
    \item \textbf{The \Gls{medical_model}}: Traditionally, ADHD or \gls{dyslexia} in engineering has been viewed as a deficit to be corrected through individual coaching or medication.
...
\begin{itemize}
    \item \textbf{Inhibitory Control}: The ability to ignore distractions. For ADHD developers, the \textit{pop-up} notifications of a linter can break a fragile state of focus.
