...
a more nuanced approach. One of the main focuses of this project is that for \gls{neurodivergent} developers, the \gls{IDE} environment often imposes a 
disproportionate Extraneous Load. When \gls{EL} is high, the cognitive budget is exhausted before the developer can engage with the core logic of the code, leading to \gls{task_paralysis}. 
